document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('blur', function(e) {
            const input = e.target;
            if (input.name && validators[input.name] && input.value.trim() !== '') {
                const error = validators[input.name](input.value);
                if (error) {
                    showError(input, error);
                } else {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '556a3bb8-ec06-4049-8675-de2fa1a33465',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '556a3bb8-ec06-4049-8675-de2fa1a33465';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '556a3bb8-ec06-4049-8675-de2fa1a33465';
